...
var micro       =   require("./models/microbiology");
...
router.route("/micro/insert").post(function(req,res){
    var db = new micro();
    var response = {};
    db.supplier = req.body.supplier;
    db.item = req.body.item;
...
router.route("/micro/:id")
    .get(function(req,res){

        var response = {};
        micro.find(req.params.id,function(err,data){
            if(err) {
                response = {"error" : true,"message" : "Error fetching data"};
            } else {
                response = {"error" : false,"message" : data};
    ...
    .put(function(req,res){
        ...
        var response = {};
        micro.findById(req.params.id,function(err,data){
            if(err) {
                response = {"error" : true,"message" : "Error fetching data"};
            } else {
    ...
    .delete(function(req,res){
        ...
        micro.findById(req.params.id,function(err,data){
            if(err) {
                ...
                micro.remove({_id : req.params.id},function(err){
                    if(err) {
                        response = {"error" : true,"message" : "Error deleting data"};
                    } else {
                        response = {"error" : true,"message" : "Data associated with "+req.params.id+"is deleted"};
